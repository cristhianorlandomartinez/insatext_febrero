<main id="main">
		<div class="container">
			...
			<!--MAIN SLIDE-->
			  <!-- carrousell de inicio home <div class="wrap-main-slide">
		  ...
		  <!--	<div class="wrap-banner style-twin-default">
			...
			<div class="wrap-show-advance-info-box style-1">
				<h3 class="title-box">LINEA DE PRODUCTOS</h3>
				<div class="wrap-top-banner">
					<a href="#" class="link-banner banner-effect-2">
						<figure><img src="{{asset('assets/images/products/1623283627.jpg')}}"width="1000" height="240" alt=""></figure>
					</a>
				</div>

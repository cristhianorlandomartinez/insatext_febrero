                    ...
                    <form class="form-horizontal" wire:submit.prevent="agregarProducto">
                                ...
                                <div class="form-group">  
                                    ...
                                    <div class="col-md-4" wire:ignore>
                                        <input type="text" id="descripcion_corta" placeholder="Escriba descripcion corta del producto"  class="form-control input-md"  wire:model="descripcion_corta"/>
                                ...
                                <div class="form-group">  
                                    ...
                                    <div class="col-md-4" wire:ignore>
                                        <input type="text" id="descripcion" placeholder="Escriba descripcion del producto"  class="form-control input-md"  wire:model="descripcion"/>

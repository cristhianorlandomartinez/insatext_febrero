...
// RUTA PARA ADMNISTRADOR
Route::middleware(['auth:sanctum', 'verified','authadmin'])->group(function() {
    Route::get('admin/dashboard', AdminDashboardComponent::class, 'index')->name('admin.dashboard');
    ...
    Route::get('/admin/productos/add',AdminAgregarProductoComponent::class)->name('admin.addproductos');
